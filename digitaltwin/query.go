...
func ExecuteBuilder[T1 models.IModel](client *Client, builder *Builder) ([]T1, error) {
	type1 := *new(T1)
...
func ExecuteBuilder3[T1, T2, T3 models.IModel](client *Client, builder *Builder) ([]TwinResult3[T1, T2, T3], error) {
	type1 := *new(T1)
	type2 := *new(T2)
	type3 := *new(T3)
...
func executeCompletedBuilder(client *Client, builder *Builder) (*QueryResultGeneric, error) {
	var err error
